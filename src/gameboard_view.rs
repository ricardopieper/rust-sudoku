...
pub struct GameboardViewSettings {
    ...
    pub board_edge_thickness: f64,

    /// Edge radius between the 3x3 sections
    pub section_edge_thickness: f64,

    /// Edge radius between cells
    pub cell_edge_thickness: f64,
...
impl GameboardViewSettings {
    ...
    pub fn new() -> GameboardViewSettings {
        GameboardViewSettings {
            position: [40.0; 2], //10px
            size: 400.0, //400px size
            background_color: [0.8, 0.8, 1.0, 1.0], //200 200 255
            border_color: [0.0, 0.0, 0.2, 1.0], 
            board_edge_color: [0.0, 0.0, 0.2, 1.0],
            section_edge_color: [0.0, 0.0, 0.2, 1.0],
            cell_edge_color: [0.0, 0.0, 0.2, 1.0],
            board_edge_thickness: 3.0,
            section_edge_thickness: 2.0,
            cell_edge_thickness: 1.0,
...
impl GameboardView {
    ...
    pub fn draw<G: Graphics, C>(
        ...
        //Draw cell borders
        let cell_edge = Line::new(settings.cell_edge_color, settings.cell_edge_thickness);
        ...
        let section_edge = Line::new(settings.section_edge_color, settings.section_edge_thickness);
        ...
        Rectangle::new_border(settings.board_edge_color, settings.board_edge_thickness)
            .draw(board_rect, &c.draw_state, c.transform, g);
